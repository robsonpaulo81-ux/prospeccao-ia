    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <a href="https://app.retellai.com" target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, padding: "6px 12px", border: "1px solid #333", borderRadius: 6, textDecoration: "none", color: "#fff", background: "#333" }}>
