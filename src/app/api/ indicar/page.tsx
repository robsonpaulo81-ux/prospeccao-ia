// app/indicar/page.jsx
//
// Página pública de indicação. Acesse via:
// seusite.com/indicar?indicador=Maria%20Silva
//
// O parâmetro "indicador" é opcional — se vier na URL, pré-preenche o
// campo "quem indica" e trava a edição, pra você poder gerar um link
// pessoal pra cada pessoa que te indica clientes.
    ...
    return (
      <div style={styles.wrapper}>
        <div style={styles.card}>
          <p style={styles.title}>Indicação recebida!</p>
          <p style={styles.subtitle}>
            Obrigado, {form.indicadorNome}. O Robson vai entrar em contato com{' '}
            {form.leadNome} em breve.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div style={styles.wrapper}>
      <form style={styles.card} onSubmit={handleSubmit}>
        ...
        <p style={styles.subtitle}>Robson Paulo · corretor de imóveis</p>
        ...
        <div style={styles.field}>
          ...
          <input
            ...
            onChange={(e) => atualizarCampo('indicadorNome', e.target.value)}
            placeholder="Maria Silva"
            disabled={!!indicadorDaUrl}
          />
        </div>
        ...
        <div style={styles.field}>
          ...
          <input
            ...
            onChange={(e) => atualizarCampo('indicadorTelefone', e.target.value)}
        ...
        <div style={styles.field}>
          ...
          <input
            ...
            type="text"
            value={form.leadNome}
            onChange={(e) => atualizarCampo('leadNome', e.target.value)}
        ...
        <div style={styles.field}>
          ...
          <input
            ...
            onChange={(e) => atualizarCampo('leadTelefone', e.target.value)}
            placeholder="(61) 99999-9999"
          />
        </div>
        ...
        <div style={styles.field}>
          ...
          <select
            ...
            onChange={(e) => atualizarCampo('interesse', e.target.value)}
          >
            <option value="casa">Casa</option>
            <option value="apartamento">Apartamento</option>
            <option value="nao_sabe">Ainda não sabe</option>
          </select>
        </div>
